    ...
    <div className="flex flex-col p-5 w-full">
      ...
      <div className="flex py-5 justify-between gap-5">
        <div className="w-2/3 flex flex-col gap-14">
          <p className="text-sm text-slate-500 w-3/4 font-semibold tracking-wide">
          ...
          <img src={aboutImg} alt="about img" className="h-[70%] w-[70%] " />
        </div>
        <div className="w-1/3 max-w-[400px] flex flex-col gap-5 ">
